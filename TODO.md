...
| Done | Medium | Setup Ollama | Add Ollama install/setup component or workflow. | Added Windows and WSL components; WSL starts `ollama.service` when systemd is running; no models are pulled automatically. |
