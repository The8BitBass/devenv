...
function Update-WingetPackage {
    ...
    if (-not (Test-WingetPackageUpgradeAvailable -Id $Id)) {
        Write-Step "No winget upgrade available for $Id"
        return
    }
    ...
    # In signed 32-bit form PowerShell reports this as -1978335189
    if ($exitCode -eq -1978335189) {
        Write-Step "No applicable winget update found for $Id"
        return
    }
...
Export-ModuleMember -Function @(
    ...
    'Get-WingetPath',
    'Test-WingetPackage',
    'Test-WingetPackageUpgradeAvailable',
